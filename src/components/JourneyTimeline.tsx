...
export function JourneyTimeline() {
  return (
    <div className="relative space-y-12">
      <div className="absolute left-4 top-0 h-full w-0.5 bg-gradient-to-b from-primary/50 via-primary to-primary/50 md:left-1/2" />
        ...
        >
          <div className="flex-1">
            <RetroCard variant="dark" className="group relative">
              <div className="absolute -left-4 top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-primary md:left-auto md:right-0 md:translate-x-1/2">
              ...
              <div className="flex items-start gap-4">
                <div className="relative">
                  <div className="relative h-12 w-12 overflow-hidden rounded-lg">
                    ...
                    <event.icon className="relative h-full w-full p-2.5 text-primary opacity-50 transition-opacity duration-300 group-hover:opacity-100" />
                  </div>
                  {event.highlight && (
                ...
                <div className="flex-1">
                  <h3 className="mb-2 font-display text-xl font-bold">{event.title}</h3>
